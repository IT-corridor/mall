...
.factory('Group', ['$resource', 'api_path', 'API',
    function($resource, api_path, API){
        return $resource(API + api_path + 'group/:pk/:action/', {}, {
...
.factory('GroupPhoto', ['$resource', 'api_path', 'API',
    function($resource, api_path, API){
...
.factory('Tag', ['$resource', 'api_path', 'API',
    function($resource, api_path, API){
        return $resource(API + api_path + 'tag/:pk/:action/', {}, {
            update: {method: 'PATCH'},
            remove: {method: 'DELETE'},
    });
}])
.factory('Member', ['$resource', 'api_path', 'API',
    function($resource, api_path, API){
        return $resource(API + api_path + 'member/short_list/', {}, {
